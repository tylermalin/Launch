...
const inputStyle: React.CSSProperties = {
  ...
  borderRadius: '8px', fontFamily: "'DM Sans', sans-serif", fontSize: '0.9rem', color: '#f5f5f5', outline: 'none', transition: 'border-color 0.2s ease',
}
        ...
        <div className="cta-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'start' }}>
          <div>
            <div className="reveal">
              ...
              <h2 style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 800, fontSize: 'clamp(2rem, 4vw, 3rem)', letterSpacing: '-0.03em', color: '#f5f5f5', lineHeight: 1.1, marginBottom: '1.25rem' }}>
                Ready to deploy<br /><span className="text-gradient-green">intelligence</span><br />in the field?
              </h2>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '0.95rem', lineHeight: 1.7, color: 'rgba(245,245,245,0.55)', marginBottom: '2rem' }}>
                Contact our team for pricing, custom configurations, and quantity discounts. We work with agricultural operations, research institutions, and environmental monitoring agencies worldwide.
              </p>
            </div>
            <div className="reveal reveal-delay-2">
              {['Gold, Silver & Bronze system tiers', 'Quantity discounts from 5+ units', 'Custom sensor configurations', 'Installation & support packages'].map((item) => (
                <div key={item} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.6rem 0', borderBottom: '1px solid rgba(255,255,255,0.05)', fontFamily: "'DM Sans', sans-serif", fontSize: '0.875rem', color: 'rgba(245,245,245,0.65)' }}>
          ...
          <div className="reveal reveal-delay-2">
            {submitted ? (
              <div style={{ background: '#141414', border: '1px solid rgba(139,255,71,0.25)', borderRadius: '16px', padding: '3rem 2rem', textAlign: 'center' }}>
                ...
                <h3 style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: '1.5rem', color: '#f5f5f5', marginBottom: '0.75rem', letterSpacing: '-0.02em' }}>Message received.</h3>
                <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '0.9rem', color: 'rgba(245,245,245,0.55)', lineHeight: 1.65 }}>Our team will reach out within 24 hours with pricing and configuration options.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} style={{ background: '#141414', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '16px', padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                {[
                  ...
                  <div key={f.key}>
                    <label style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '0.65rem', color: 'rgba(245,245,245,0.4)', letterSpacing: '0.1em', textTransform: 'uppercase', display: 'block', marginBottom: '0.5rem' }}>{f.label}</label>
                ...
                <div>
                  <label style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '0.65rem', color: 'rgba(245,245,245,0.4)', letterSpacing: '0.1em', textTransform: 'uppercase', display: 'block', marginBottom: '0.5rem' }}>Message</label>
