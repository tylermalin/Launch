...
// Unified top-level nav. Network = coverage map / hex explorer; Tokenomics and
// Learn are grouping labels (dropdown menus are a follow-up).
const primaryNavLinks = [
  { href: '/sensors',        label: 'Sensors',      active: (p: string) => p.startsWith('/sensors'), authOnly: false },
  { href: '/explorer',       label: 'Network',      active: (p: string) => p === '/explorer' || p.startsWith('/explorer/'), authOnly: false },
  { href: '/docs/tokenomics', label: 'Tokenomics',  active: (p: string) => p.startsWith('/docs/tokenomics'), authOnly: false },
  ...
  { href: '/docs',           label: 'Learn',        active: (p: string) => p.startsWith('/docs') || p === '/whitepaper', authOnly: false },
]
