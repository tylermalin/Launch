...
/**
 * TOC scrollspy + copy-link behavior for every legal-hub page.
 * Direct port of the inline <script> at the bottom of every designed
 * legal HTML file (claude.ai/design handoff bundle).
 *
 * Scoped to .mlma-legal-doc so it doesn't run on unrelated routes.
 */
export default function LegalPageScrollSpy() {
  useEffect(() => {
